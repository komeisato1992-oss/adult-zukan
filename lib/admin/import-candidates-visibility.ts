...
export function buildSummaryFromListItems(
  ...
  return {
    ...
    lastPopularCollectedAt: state.lastPopularCollectedAt,
    collectionState: {
      pastOffset: state.pastOffset,
      nextPastOffset: state.pastOffset,
      lastPastStartOffset: state.lastPastStartOffset,
      popularOffset: state.popularOffset,
      nextPopularOffset: state.popularOffset,
      lastPopularStartOffset: state.lastPopularStartOffset,
      targetTotalCount: state.targetTotalCount,
